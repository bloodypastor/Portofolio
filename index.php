...
<meta name="keywords" content="My Profile Responsive web template, web design" />
<!-- css files -->
<link href="css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
<link href="css/cobox.css" rel="stylesheet" type="text/css">
<link href="css/portfolio.css" rel="stylesheet" type="text/css" media="all">
<link href="css/style.css" rel="stylesheet" type="text/css" media="all"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<!-- /css files -->
<!-- font links -->
...
<link href='//fonts.googleapis.com/css?family=Cinzel:400,700,900' rel='stylesheet' type='text/css'>
    <link href="https://fonts.googleapis.com/css?family=Open+Sans|Proza+Libre:500" rel="stylesheet">
<!-- /font links -->
<!-- js files -->
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.html">Datsko Victor</a>
            </div>
		...
		<div class="row">
			<div class="col-md-4 col-xs-12">
				<div class="mydetails slideanim text-center">
					<img class="img-circle img-responsive" src="images/man.jpg" alt="Generic placeholder image" width="200" height="300">
					<h3>Datsko Victor</h3>
					<p>Web Developer</p>
					<div class="social-icons">
						<a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
		...
		<section class="vertical" id="grid3d">
				...
				<div class="content">
					<div>
						...
						<h3 class="content-text">DAVID CHU'S CHINA BISTRO</h3>
...
<div class="mygallery" id="gallery">
	...
	<div class="text-center">
		...
		<a href="images/me3-3.jpg" title="My Image Gallery"><img src="images/me3.jpg" alt="example-1" class="img-responsive slideanim"></a>
		<a href="images/me2-2.jpg" title="My Image Gallery"><img src="images/me2.jpg" alt="example-2" class="img-responsive slideanim"></a>
		<a href="images/me4-4.jpg" title="My Image Gallery"><img src="images/me4.jpg" alt="example-2" class="img-responsive slideanim"></a>
...
<div class="contact-me" id="contact">
	...
	<footer>
		<div class="row">
			...
			<div class="col-md-6 slideanim">
				<div class="contact-info">
					<h4>Contact Info</h4>
					<p>Please, if you have some questions, feel free to contact me.</p>
					<div class="footer-info">
						<div>
                            <i class="fa fa-globe" aria-hidden="true"></i>
							<p class="p2">Ivano Frankivsk, Ukraine</p>
						</div>
						<div>
                            <i class="fa fa-phone" aria-hidden="true"></i>
							<p class="p1">+38 067 342 30 69</p>
						</div>
						<div class="mail">
                            <i class="fa fa-envelope-o" aria-hidden="true"></i>
							<p class="p1"><a href="mailto:myemail@something.com">v.b.datsko@gmail.com</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="copyright">
			<p class="text-center">© 2016 Datsko Victor. All Rights Reserved</p>
		</div>
